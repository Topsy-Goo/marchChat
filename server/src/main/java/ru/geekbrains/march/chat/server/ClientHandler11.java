...
public class ClientHandler11
{
    ...
    public ClientHandler11 (Server11 serv, Socket serverSideSocket)
    {
...
//Обработчик команды CMD_LOGIN.
    ...
    {
        if (nickname != null)
            throw new RuntimeException("ERROR @ onCmdLogin() : повторная регистрация?");
