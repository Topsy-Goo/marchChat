...
import static ru.geekbrains.march.chat.server.ServerApp10.CMD_CONNECTED;
import static ru.geekbrains.march.chat.server.ServerApp10.*;

public class ClientHandler10
{
    ...
    public ClientHandler10 (Server10 serv, Socket serverSideSocket)
    {
